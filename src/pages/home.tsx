...
import { getLayoutBasedOnCommand, getRecommendedLayout } from '@/api/layout';
...
const Home = () => {
  ...
  useEffect(() => {
    window.electron
      ...
      .catch(console.error);
    // console.log("Getting available application list")
    // console.log(window.electron.getAllApplications());
  }, []);
  ...
  return (
    <div className='relative h-screen rounded-lg shadow-lg'>
      <div className='flex flex-col bg-white text-gray-800 w-screen overflow-auto'>
        ...
        />
        {/* list view */}
        <div className='p-4 overflow-y-scroll max-h-[340px]'>
          ...
          <div className='flex items-center justify-between mb-4'>
            ...
            <button onClick={() => onPlanningLayout()} className='text-blue-500'>
              Go
            </button>
          </div>
          <ul className='mb-4'>
